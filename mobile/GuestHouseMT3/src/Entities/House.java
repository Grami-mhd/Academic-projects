...
public class House {
   ...
   protected User fk_user;
    ...
    public House(int id, String country, String town, String nature, int price, String description, int rating) {
        this.id = id;
    ...
    public House(String country, String town, String nature, int price, String description,User fk_user) {
        this.country = country;
        this.town = town;
        this.nature = nature;
        this.price = price;
